...
const renderChat = (
  ...
  chatContainer.classList.add("markov-chatbot-kit-chat-container");

  const innerContainer = document.createElement("div");
  innerContainer.classList.add("markov-chatbot-kit-chat-inner-container");
...
const createHeader = (config) => {
  ...
  header.classList.add("markov-chatbot-kit-chat-header");
...
const createMessageContainer = (
  ...
  container.classList.add("markov-chatbot-kit-chat-message-container");
...
const createForm = (messageParserInstance, updater) => {
  const container = document.createElement("div");
  container.classList.add("markov-chatbot-kit-chat-input-container");

  const form = document.createElement("form");
  form.classList.add("markov-chatbot-kit-chat-input-form");

  const input = document.createElement("input");
  input.classList.add("markov-chatbot-kit-chat-input");
  input.placeholder = "Write your message here";

  const btn = document.createElement("button");
  btn.classList.add("markov-chatbot-kit-chat-btn-send");
  ...
  imgContainer.classList.add("markov-chatbot-kit-chat-btn-send-icon");
...
const createUserChatMessage = (message) => {
  ...
  container.classList.add(
    "markov-chatbot-kit-user-chat-message-container"
  );

  const avatarContainer = document.createElement("div");
  avatarContainer.classList.add(
    "markov-chatbot-kit-user-avatar-container"
  );

  const imgContainer = document.createElement("div");
  imgContainer.classList.add("markov-chatbot-kit-user-avatar-icon");
  ...
  messageContainer.classList.add("markov-chatbot-kit-user-chat-message");
  messageContainer.textContent = message;

  const arrow = document.createElement("div");
  arrow.classList.add("markov-chatbot-kit-user-chat-message-arrow");
...
export const createBotChatMessage = (
  ...
  const container = document.createElement("div");
  container.classList.add(
    "markov-chatbot-kit-chat-bot-message-container"
  );

  const avatarContainer = document.createElement("div");
  avatarContainer.classList.add(
    "markov-chatbot-kit-chat-bot-avatar-container"
  );

  const paragraph = document.createElement("p");
  paragraph.textContent = "B";
  paragraph.classList.add("markov-chatbot-kit-chat-bot-avatar-letter");

  const messageContainer = document.createElement("div");
  messageContainer.classList.add("markov-chatbot-kit-chat-bot-message");
  ...
  const arrow = document.createElement("div");
  arrow.classList.add("markov-chatbot-kit-chat-bot-message-arrow");
